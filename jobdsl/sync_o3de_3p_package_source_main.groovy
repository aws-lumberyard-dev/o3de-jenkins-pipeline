freeStyleJob('sync_o3de_3p-package-source_main') {
    label('sync-fork')
    parameters {
        stringParam('UPSTREAM', 'https://github.com/o3de/3p-package-source.git', 'Updates will be fetched from this repo.')
        stringParam('ORIGIN', 'https://github.com/aws-lumberyard-dev/3p-package-source.git', 'Target repo for the sync. Changes will be pushed to this repo.')
