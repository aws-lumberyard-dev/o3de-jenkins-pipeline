freeStyleJob('sync_o3de-multiplayersample_development') {
    label('sync-fork')
    parameters {
        stringParam('UPSTREAM', 'https://github.com/o3de/o3de-multiplayersample.git', 'Updates will be fetched from this repo.')
        stringParam('ORIGIN', 'https://github.com/aws-lumberyard-dev/o3de-multiplayersample.git', 'Target repo for the sync. Changes will be pushed to this repo.')
