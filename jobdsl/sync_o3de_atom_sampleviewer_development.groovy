freeStyleJob('sync_o3de-atom-sampleviewer_development') {
    label('sync-fork')
    parameters {
        stringParam('UPSTREAM', 'https://github.com/o3de/o3de-atom-sampleviewer.git', 'Updates will be fetched from this repo.')
        stringParam('ORIGIN', 'https://github.com/aws-lumberyard-dev/o3de-atom-sampleviewer.git', 'Target repo for the sync. Changes will be pushed to this repo.')
    ...
    scm {
        git {
            ...
            remote {
                credentials('github')
                url('https://github.com/o3de/o3de-atom-sampleviewer.git')
            }
        }
    }
    steps {
